...
Check what an incoming payment would slice into before sending funds.
...
| `quote @handle <amount> <token>` | `@TenderRWABot quote @whoknows 50 USDC` | Returns real-time output estimates. |
...
**Bot Response Example**:
> *“Quote for @whoknows: 100 USDC slices into ~0.13 SPYx, ~0.24 NVDAx, 20 USDC. Tap the link in my bio to settle on TENDER.”*
